...
for WaitingTime = [20] %in min 2 5 10 15
    for Delay = [10] % in min
        for PenRate= [0.7]
            for mult= [2] %0.0078 0.0156 0.0312 0.0625 0.125 0.25 0.5 1 2
                gamma = 0;
                TotGamma2 = 0;
                TotGamma3 = 0;
                TotGamma4 = 0;
                ...
                solKN = LTIFM_reb(Demands_rp+DemandS ,city);
                ...
                save(strcat(city,'/Congestion/Results/solKn_Delay',num2str(Delay),'Exo',num2str(PenRate),'Dem',num2str(mult),'.mat'),'solKN')
            end
