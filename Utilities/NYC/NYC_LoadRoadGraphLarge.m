...
G_road=digraph(LinkTime/3600); %hour
FreeFlowTime = G_road.Edges.Weight'; %vehilces/hour
N_lanes = 1;
Capacity = FreeFlowTime*0 + NominalCapacity*N_lanes*8*3600/CAR_LENGTH; %car/hNominalCapacity*N_lanes*               %
load('NYC_Demands')
DemandS = zeros(357);
for iii=1:53000
    x = outdata(iii,2);
...
save('Graphs.mat', 'G_road','NodesLoc','LinkTime','FreeFlowTime','DemandS','Capacity');
